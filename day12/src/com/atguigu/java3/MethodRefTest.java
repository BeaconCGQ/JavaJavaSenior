 ...
 *  情况三  类:: 非静态方法
 *
 * 5.方法引用使用：要求接口中的抽象方法形参列表和返回值类型与方法引用的形参列表和返回值类型相等(针对情况一、二)
 *
 * Created by cgq
 */
public class MethodRefTest {
	...
	public void test2() {
		...
		Employee employee = new Employee(1001,"Tom",24,5777);
	...
	public void test5() {
		...
		System.out.println(com1.compare("abc", "dbc"));
	...
	public void test6() {
		...
		System.out.println(pre2.test("af","ad"));
